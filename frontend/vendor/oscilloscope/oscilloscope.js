/* Vendored from mathiasvr/audio-oscilloscope 1.3.0 (src/index.js).
 * MIT — Copyright (c) 2015-2018 Mathias Rasmussen. See LICENSE.
 * Adaptation: removed the ES module export for classic browser scripts.
 */
class Oscilloscope {
